...
import { getSmsStatisticsService } from "./otp.service.js";
// OTP flow disabled — uncomment when re-enabling send/verify/resend handlers:
// import { resendOtpService, sendOtpService, verifyOtpService } from "./otp.service.js";
// import { validateOtpInput, validatePhoneInput } from "./otp.validation.js";
// import env from "../../config/env.js";

// OTP flow disabled — uncomment handlers and wire routes in otp.router.js to re-enable
